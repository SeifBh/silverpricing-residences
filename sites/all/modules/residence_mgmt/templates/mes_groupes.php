<section class="groupes-section">
  <div class="card mg-t-10 mg-b-10">
        <div class="card-header d-sm-flex align-items-start justify-content-between">
            <h5 class="tx-8rem tx-uppercase tx-bold lh-5 mg-b-0">Mes Groupes</h5>
        </div>
        <div class="card-body pd-y-15 pd-x-10">
            <div class="row">
              <div class="col-md-12">
                <table id="mes-groupes-table" class="table table-hover table-sm">
                  <thead>
                      <tr>
                  ...
                  <tbody>
                      <?php foreach( $groupes as $groupe ): ?>
                          <tr>
                              ...
                              <td><a href="<?php echo "/edit-groupe/$groupe->tid"; ?>" class="btn btn-primary btn-sm btn-icon"><i data-feather="edit"></i></a></td>
                          </tr>
                      <?php endforeach; ?>
                  </tbody>
              </table>
