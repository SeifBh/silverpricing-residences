                            ...
                            <fieldset class="form-fieldset mg-t-10">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" step="1" min="0" lang=F"en" class="form-control" name="nombre_cd_standard" id="nombre_cd_standard" value="<?php echo $chambre->field_nombre_cd_standard['und'][0]['value']; ?>">
                                    </div>
